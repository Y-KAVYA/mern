...
// Create instance of ShamirSecret
const secretSharing = new ShamirSecret();

// Calculate secrets
const secret1 = secretSharing.findSecret(testCase1);
const secret2 = secretSharing.findSecret(testCase2);
